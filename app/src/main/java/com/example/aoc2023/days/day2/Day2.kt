package com.example.aoc2023.days.day2
...
class Day2: Solution(2) {
    override suspend fun answer1(context: Context) = input(context).lines().sumOf {
        possibleGameValue(it)
    }

    override suspend fun answer2(context: Context) = input(context).lines().sumOf{
        minCubesPower(it)
    }
